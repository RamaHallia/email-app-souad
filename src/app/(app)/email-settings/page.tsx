    ...
    if (!showForm && isConfigured) {
        ...
        return (
            <div className="max-w-4xl">
                <div className="bg-gradient-to-r from-blue-600 to-blue-500 rounded-2xl p-8 text-white mb-6">
                ...
                <div className="bg-white rounded-2xl p-8 shadow-sm mb-6">
                    {!isOAuthProvider && (
                        <>
                            <h3 className="text-xl font-bold text-gray-900 mb-6">Informations de connexion</h3>
                            ...
                            <h3 className="text-xl font-bold text-gray-900 mb-6 mt-8">Configuration serveur IMAP</h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                <div>
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-6 mt-8">Informations de l'entreprise</h3>
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <p className="font-medium text-gray-900 whitespace-pre-wrap">{formData.services || 'Non renseigné'}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex gap-4 justify-end">
                    <button
                        ...
                        className="bg-white border-2 border-blue-600 text-blue-600 px-8 py-3 rounded-lg font-medium flex items-center gap-2 hover:bg-blue-600 hover:text-white transition-colors"
                    >
                    ...
                    {!isActive && (
                        <button
                            ...
                            className="bg-gradient-to-r from-blue-600 to-blue-500 text-white px-8 py-3 rounded-lg font-medium flex items-center gap-2 hover:shadow-lg transition-shadow disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                ...
                <>
                    <div className="bg-white rounded-2xl p-8 shadow-sm mb-6">
                        <div className="flex items-center gap-2 mb-6">
                            ...
                            <h3 className="text-xl font-bold text-gray-900">Informations de connexion</h3>
                        </div>
                    ...
                    <div className="bg-white rounded-2xl p-8 shadow-sm mb-6">
                        <div className="flex items-center gap-2 mb-6">
                            ...
                            <h3 className="text-xl font-bold text-gray-900">Configuration IMAP</h3>
                        </div>
